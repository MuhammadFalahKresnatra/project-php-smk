...
<head>
    ...
    <title>Restoran MFalah | Aplikasi Restoran </title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 mt-4">
                <h2><a href="index.php">Resto FAL</a></h2>
            </div>
                ...
                <?php 
                    ...
                    if (isset($_SESSION['pelanggan'])) {
                        echo '
                            ...
                            <div class="float-end mt-4 me-4" ><a> Cart : ( <a href="?f=home&m=beli"> '.cart().'</a> ) </div>
                            <div class="float-end mt-4 me-4" ><a href="?f=home&m=history"> History </a> </div>
                        ';
                    }else{
                        echo '
        ...
        <div class="row mt-5">
            ...
            <div class="col">
                <p class="text-center"> 2022 - copyright@maspalah.com </p>
            </div>
